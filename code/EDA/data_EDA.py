...
def load_data(data_path):
    ...
    return interactions, directors, genres, titles, writers, years

def process_items(interactions, directors, genres, titles, writers, years):
    # Genre, Writer, Director를 한 칸에 넣기
...
def process_users(interactions, directors, genres, titles, writers, years, items):
    #item 추가
...
def save_data(data, data_path, filename):
    data.to_csv(os.path.join(data_path, filename), sep=',', index=False)

def main():
    data_path = '../../data/train'
    interactions, directors, genres, titles, writers, years = load_data(data_path)
    items = process_items(interactions, directors, genres, titles, writers, years)
    users = process_users(interactions, directors, genres, titles, writers, years, items)
    import pdb; pdb.set_trace()

    save_data(items, data_path, 'EDA_items.csv')
    save_data(users, data_path, 'EDA_users.csv')
