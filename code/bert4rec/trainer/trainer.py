...
class Trainer:
    ...
    def get_full_sort_score(self, epoch, answers, pred_list, mode):
        ...
        wandb.log({
            f"{mode}_recall@5": recall[0],
            f"{mode}_ndcg@5": ndcg[0],
            f"{mode}_recall@10": recall[1],
            f"{mode}_ndcg@10": ndcg[1],
        })
        print(post_fix)
...
class FinetuneTrainer(Trainer):
    ...
    def iteration(self, epoch, dataloader, mode="train"):
        ...
        if mode == "train":
            ...
            wandb.log({
                "train_avg_loss": rec_avg_loss / len(rec_data_iter),
                "train_cur_loss": rec_cur_loss,
            })
